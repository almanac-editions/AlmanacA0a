...
| `MEASUREMENT_LOG.md` | what the edition cost and what the gates caught (a companion document, produced alongside the edition) |
...
the closure-evidence repair (F-E1) than before it. As things stand the edition faithfully cites the
